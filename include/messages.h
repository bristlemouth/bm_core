...
#define bcmp_heartbeat_struct_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_32BIT,
...
#define bcmp_echo_request_struct_layout \
 BCMP_PARSER_64BIT, \
  ...
  BCMP_PARSER_16BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_echo_request_serialize_params { {bcmp_echo_request_struct_layout}, sizeof(BCMPEchoRequest) }
...
#define bcmp_echo_reply_struct_layout \
  ...
  BCMP_PARSER_16BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_echo_reply_serialize_params { {bcmp_echo_reply_struct_layout}, sizeof(BCMPEchoReply) }

typedef struct {
  // Node ID of the target node for which the request is being made. (Zeroed = all nodes)
  uint64_t target_node_id;
} __attribute__((packed)) BCMPDeviceInfoRequest;
#define bcmp_device_info_request_struct_layout \
  BCMP_PARSER_64BIT,
#define bcmp_device_info_request_params { {bcmp_device_info_request_struct_layout}, sizeof(BCMPDeviceInfoRequest) }
...
#define bcmp_device_info_reply_layout \
  bcmp_device_info_layout, \
  BCMP_PARSER_8BIT, \
  BCMP_PARSER_8BIT,
#define bcmp_device_info_reply_params { {bcmp_device_info_reply_layout}, sizeof(BCMPDeviceInfoReply) }
...
#define bcmp_protocol_caps_request_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_protocol_caps_request_params { {bcmp_protocol_caps_request_layout}, sizeof(BCMPProtocolCapsRequest) }
...
#define bcmp_protocol_caps_reply_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_16BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_protocol_caps_reply_params { {bcmp_protocol_caps_reply_layout}, sizeof(BCMPProtocolCapsReply) }

typedef struct {
  // Node ID of the target node for which the request is being made. (Zeroed = all nodes)
  uint64_t target_node_id;
} __attribute__((packed)) BCMPNeighborTableRequest;
#define bcmp_neighbor_table_request_layout \
  BCMP_PARSER_64BIT,
#define bcmp_neighbor_table_request_params { {bcmp_neighbor_table_request_layout}, sizeof(BCMPNeighborTableRequest) }
...
#define bcmp_neighbor_table_reply_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_8BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_neighbor_table_reply_params { {bcmp_neighbor_table_reply_layout}, sizeof(BCMPNeighborTableReply) }
...
#define bcmp_neighbor_info_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_8BIT, \
  BCMP_PARSER_16BIT,
...
#define bcmp_resource_table_request_layout \
  BCMP_PARSER_64BIT,
#define bcmp_resource_table_request_params { {bcmp_resource_table_request_layout}, sizeof(BCMPResourceTableRequest) }
...
#define bcmp_resource_table_reply_layout \
  ...
  BCMP_PARSER_16BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_resource_table_reply_params { {bcmp_resource_table_reply_layout}, sizeof(BCMPResourceTableReply) }
...
#define bcmp_neighbor_proto_request_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_neighbor_proto_request_params { {bcmp_neighbor_proto_request_layout}, sizeof(BCMPNeighborProtoRequest) }
...
#define bcmp_neighbor_proto_reply_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_16BIT,
#define bcmp_neighbor_proto_reply_params { {bcmp_neighbor_proto_reply_layout}, sizeof(BCMPNeighborProtoReply) }
...
#define bcmp_system_time_header_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_64BIT,
#define bcmp_system_time_header_params { {bcmp_system_time_header_layout}, sizeof(BCMPSystemTimeHeader) }

typedef struct {
  BCMPSystemTimeHeader header;
} __attribute__((packed)) BCMPSystemTimeRequest;
#define bcmp_system_time_request_layout \
  bcmp_system_time_header_layout,
#define bcmp_system_time_request_params { {bcmp_system_time_request_layout}, sizeof(BCMPSystemTimeRequest) }
...
#define bcmp_system_time_response_layout \
  bcmp_system_time_header_layout, \
  BCMP_PARSER_64BIT,
#define bcmp_system_time_response_params { {bcmp_system_time_response_layout}, sizeof(BCMPSystemTimeResponse) }
...
#define bcmp_system_time_set_layout \
  bcmp_system_time_header_layout, \
  BCMP_PARSER_64BIT,
#define bcmp_system_time_set_params { {bcmp_system_time_set_layout}, sizeof(BCMPSystemTimeLayout) }

typedef struct {
  // Node ID of the target node for which the request is being made. (Zeroed = all nodes)
  uint64_t target_node_id;
} __attribute__((packed)) BCMPNetstatRequest;
#define bcmp_netstat_request_layout \
  BCMP_PARSER_64BIT,
...
#define bcmp_netstat_reply_layout \
  BCMP_PARSER_64BIT,
...
#define bcmp_power_state_request_layout \
  BCMP_PARSER_64BIT,
#define bcmp_power_state_request_params { {bcmp_power_state_request_layout}, sizeof(BCMPPowerStateRequest) }
...
#define bcmp_power_state_reply_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_8BIT,
#define bcmp_power_state_reply_params { {bcmp_power_state_reply_layout}, sizeof(BCMPPowerStateReply) }
...
#define bcmp_reboot_request_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_8BIT,
...
#define bcmp_reboot_reply_layout \
  BCMP_PARSER_64BIT, \
  BCMP_PARSER_8BIT,
...
#define bcmp_net_assert_quiet_layout \
  BCMP_PARSER_64BIT,
#define bcmp_net_assert_quiet_params { {bcmp_net_assert_quiet_layout}, sizeof(BCMPNetAssertQuiet) }
